  ...
  return (
    <div className="relative h-screen flex items-start pt-20 justify-center overflow-hidden bg-gray-100 dark:bg-[#1c1d1e] transition-colors duration-300">
      ...
      <div className="absolute bottom-0 w-full flex flex-col md:flex-row justify-center md:justify-between px-4 md:px-8 lg:px-20 pb-4 md:pb-8 opacity-70 gap-4">
        ...
        {/* Enterprise card */}
        <div className="w-full md:w-5/12 lg:w-3/12 rounded-lg h-auto min-h-40 border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-[#292a2b] flex flex-col items-center justify-center p-6 transition-colors duration-300">
