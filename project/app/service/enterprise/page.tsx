...
import { Server, Users, Cloud, Globe, Smartphone, RefreshCw, ChevronRight, Briefcase, ArrowLeft } from "lucide-react";
    ...
    <div className="relative flex flex-col items-start pt-16 pb-0 justify-start bg-gradient-to-b from-gray-50 to-gray-100 dark:from-[#1a1b1c] dark:to-[#1c1d1e] transition-colors duration-500 h-auto">
      ...
      {/* <ParallaxSection speed={0.2} direction="up" className="z-10 container mx-auto px-4 mb-0 pb-0"> */}
        ...
        <motion.h1 
          ...
          className="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-gray-900 dark:text-white transition-colors duration-300 border-l-4 border-blue-500 pl-3"
        >
        ...
        >
          <div className="prose dark:prose-invert max-w-none transition-colors duration-300">
            <motion.div variants={staggerContainer} initial="hidden" animate="visible">
              <motion.div variants={fadeIn} className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
                <div className="flex items-start">
                  <Briefcase className="h-6 w-6 mr-3 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-1" />
                  <p className="text-blue-800 dark:text-blue-300 m-0">
                    At WebDrift, we offer comprehensive enterprise solutions designed to transform your business operations.
                    Our team of experts is committed to delivering customized services that drive growth and efficiency.
                  </p>
                </div>
              </motion.div>
                      ...
                      <ul className="space-y-2 mb-3">
                        {service.features.map((feature, i) => (
                          <li key={i} className="flex items-start text-sm">
                            <span className="inline-flex items-center justify-center w-5 h-5 mr-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex-shrink-0">
