  ...
  const enterpriseCards = [
    {
      ...
      description:
        "Streamline your business operations with tailored Enterprise Resource Planning solutions designed to fit your specific needs and workflows.",
    ...
    },
    {
      ...
      description:
        "Transform your customer relationships with powerful Customer Relationship Management systems that enhance engagement and drive sales growth.",
    ...
    },
    {
      ...
      description:
        "Securely transition your business to the cloud with our expert migration services and robust infrastructure solutions.",
    ...
    },
    {
      ...
      description:
        "Create impactful online experiences with our custom web development services focused on performance, design, and user experience.",
    ...
    },
    {
      ...
      description:
        "Extend your digital presence with native and cross-platform mobile applications built for performance and user engagement.",
    ...
    },
    {
      ...
      description:
        "Revitalize outdated systems and technologies to improve efficiency, reduce costs, and enhance security across your organization.",
  ...
  const soloCards = [
    {
      ...
      description:
        "Launch your online presence with a professional website or e-commerce store tailored to your specific business needs and target audience.",
    ...
    },
    {
      ...
      description:
        "Turn your idea into a functional Minimum Viable Product to validate your concept, attract early users, and secure potential investors.",
    ...
    },
    {
      ...
      description:
        "Organize your customer relationships and streamline your sales process with easy-to-use CRM tools designed for solo business owners.",
    ...
    },
    {
      ...
      description:
        "Expand your reach with a custom mobile application that engages your customers and enhances your business accessibility.",
  ...
  return (
    <div className="relative flex flex-col items-start pt-16 pb-0 justify-start bg-gradient-to-b from-gray-50 to-gray-100 dark:from-[#1a1b1c] dark:to-[#1c1d1e] transition-colors duration-500 h-auto">
      ...
      {/* <ParallaxSection
        speed={0.2}
        direction="up"
        className="z-10 container mx-auto px-4 mb-0 pb-0"
      > */}
        <motion.div
        ...
        >
          <Link
            href="/service"
            className="flex items-center mr-3 bg-white dark:bg-[#292a2b] px-3 py-2 rounded-lg shadow-sm hover:shadow-md text-purple-600 dark:text-purple-400 transition-all duration-300"
          >
        ...
        >
          <div className="prose dark:prose-invert max-w-none transition-colors duration-300">
            ...
            >
              ...
              >
                <div className="flex items-start">
                  ...
                  <p className="text-purple-800 dark:text-purple-300 m-0">
                    At WebDrift, we understand the unique challenges solo
                    entrepreneurs face. Our tailored services help you build and
                    scale your business efficiently without the overhead of a
                    large team.
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div
                variants={fadeIn}
                className="mt-6 p-5 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-200 dark:border-gray-700"
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  We offer flexible, affordable solutions tailored specifically
                  for solo entrepreneurs and small businesses looking to make a
                  big impact.
                </p>
